...
//           )}
//         >
//           <div className="p-1">{React.Children.map(children, (child) => React.cloneElement(child as React.ReactElement, { onSelect: handleSelect, onClose: handleClose }))}</div>
//         </div>
//       )}
//     </div>
//   )
...
// const SelectItem = React.forwardRef<
//   HTMLDivElement,
//   React.HTMLAttributes<HTMLDivElement> & { value: string; onSelect?: (value: string) => void; onClose?: () => void }
// >(({ value, children, onSelect, onClose, className, ...props }, ref) => (
//   <div
//     ref={ref}
//     onClick={() => {
//       onSelect?.(value)
